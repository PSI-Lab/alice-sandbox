...
A specific RNA secondary structure can be represented by an upper triangular matrix (excluding the diagonal)
...
This structure can be represented by the upper triangular $10 \times 10$ matrix with all $0$'s,
