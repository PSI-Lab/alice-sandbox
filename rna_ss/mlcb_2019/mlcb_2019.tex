...
Although trained on synthetic dataset with no pseudoknot structure,
since our model doesn't incorporate hard-wired rules on how local structures assemble into global structure,
our model is actually able to generate structure with pseudoknots.
We illustrate with one example: TODO sequence ref.
We sampled 100 structures from the model, and recovered ? with knots. (TODO also show other strutures? plot? pending fixing arr2db)
