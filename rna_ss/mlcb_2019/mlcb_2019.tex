...
which is minimized efficiently using dynamic programming (DP).
...
interaction between any two positions in the sequence. (TODO number of layers, filter size)
    ...
    \item Multiple 2D feature maps, each produced by one pair of 1D activations at a specific layer,
...
We refer to 1-2 as the sequence encoder, and 3-4 as the sequence generator. (TODO)
