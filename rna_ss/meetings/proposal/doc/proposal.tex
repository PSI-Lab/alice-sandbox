...
% TODO review traditional way of resolving structure, RNAstrand database (used in SG paper from RNAfold)
% TODO review free energy and dynamic programming (maybe in related work)
% TODO review base pairing, show a plot of matrix, describe ensemble

% TODO comparative sequence analysis
...
\begin{itemize}
%    \item State-of-art thermodynamic models are based of free energy minimization,
%    where the free energy were measured experimentally on specific types of sub structures.
...
\begin{itemize}
    ...
    %TODO trans-factor generalization
...
% a little bit of noise needs to be added to the input to start GA
