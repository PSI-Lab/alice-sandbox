...
def main(config, data_file, output_dir):
    ...
    #               optimizer=opt)
    model.compile(loss={'ar_label': custom_loss, 'fe': 'mean_squared_error', 'non_ar_label': custom_loss},
                  loss_weights={'ar_label': 1.0, 'fe': 0.0, 'non_ar_label': 1.0},  # FIXME turn off fe loss for now
                  optimizer=opt)
    # TODO loss weighting
