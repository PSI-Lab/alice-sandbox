...
def main(split):
    ...
    # model
    model = build_model_residual_conv(L=32, residual_conv=residual_conv, nout=7)
    model.compile(loss='categorical_crossentropy', optimizer=keras.optimizers.Adam(0.0001))
