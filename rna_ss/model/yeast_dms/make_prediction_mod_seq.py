"""
Make prediction on ModSeq dataset
"""
import os
# import sys
# import imp
...
def main(config):
    ...
    metadata, df = read_dataframe('data/yeast_modseq_test.csv')
    ...
    write_dataframe(metadata, df, 'prediction/yeast_modseq_test_prediction.csv')
