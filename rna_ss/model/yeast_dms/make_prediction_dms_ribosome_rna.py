"""
Make prediction on yeast solved structures
"""
import os
# import sys
# import imp
...
def main(config):
    ...
    # load RNA STRAND DB TODO hard-coded for now
    metadata, df = read_dataframe('data/yeast_dms_ribosome_rna.csv')
    ...
    write_dataframe(metadata, df, 'prediction/yeast_dms_ribosome_rna_prediction.csv')
