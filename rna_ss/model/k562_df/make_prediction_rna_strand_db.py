"""
Make prediction on human sequences from RNA STRAND DB
"""
import os
# import sys
# import imp
...
def main(config):
    ...
    # load RNA STRAND DB TODO hard-coded ID for now
    metadata, df = read_dataframe(dc.Client().get_path('dz8AG3'))
    ...
    write_dataframe(metadata, df, 'prediction/rna_strand_db.csv')
