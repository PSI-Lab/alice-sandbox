...
def main(validation_fold_idx):
    ...
    print("Num disjoint intervals in training: %d" % len(training_intervals))
    print("Num disjoint intervals in validation: %d" % len(validation_intervals))

    training_dataset = DataGenerator(training_intervals)
    validation_dataset = DataGenerator(validation_intervals)
...
if __name__ == "__main__":
    ...
    assert 0 <= fold_idx < len(config['interval_folds'])
    main(fold_idx)
