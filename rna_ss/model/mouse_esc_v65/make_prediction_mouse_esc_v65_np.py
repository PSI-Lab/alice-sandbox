...
def main(config):
    ...
    metadata, df = read_dataframe(gzip.open('data/mouse_esc_v65_icshape_np_vivo.csv.gz'))
    ...
    write_dataframe(metadata, df, 'prediction/mouse_esc_v65_icshape_np_vivo_prediction.csv')
