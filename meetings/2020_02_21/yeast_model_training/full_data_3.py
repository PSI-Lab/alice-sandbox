...
df_raw_1 = pd.read_csv('data/training/raw_pair_wise/SGA_ExE.txt', 
...
df_raw_2 = pd.read_csv('data/training/raw_pair_wise/SGA_ExN_NxE.txt', 
                     sep='\t')[['Query Strain ID', 'Array Strain ID', 
                                'Query single mutant fitness (SMF)', 'Array SMF',
                                'Double mutant fitness']].rename(columns={
    'Query Strain ID': 's1',
...
df_raw_3 = pd.read_csv('data/training/raw_pair_wise/SGA_NxN.txt', 
                     sep='\t')[['Query Strain ID', 'Array Strain ID', 
                                'Query single mutant fitness (SMF)', 'Array SMF',
                                'Double mutant fitness']].rename(columns={
    'Query Strain ID': 's1',
