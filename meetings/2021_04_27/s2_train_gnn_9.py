...
from util_s2_gnn import SimpleNodeEdgeConv, roc_prc, make_dataset, masked_loss_bce, get_logger
...
class Net(torch.nn.Module):
    def __init__(self, num_hids, k, embed_dim):
        ...
        self.gcn = [SimpleNodeEdgeConv(embed_dim, num_hids[0], 1)]
        for num_hid_prev, num_hid in zip(num_hids[:-1], num_hids[1:]):
            self.gcn.append(SimpleNodeEdgeConv(num_hid_prev, num_hid, 1))
