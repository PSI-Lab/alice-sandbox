...
df = pd.read_pickle('data/rand_seqs_var_len_sample_mfe_10_100_500000.pkl.gz')
df = add_column(df, 'bounding_boxes',
                 ['seq', 'one_idx'], add_target, pbar=True)

df.to_pickle('data/rand_seqs_var_len_sample_mfe_10_100_500000_pixel_bb.pkl.gz', compression='gzip')
